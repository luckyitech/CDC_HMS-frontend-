...
import { MessageCircle, FlaskConical, Bell, BarChart3, Facebook, Instagram } from 'lucide-react';
...
const Inbox = () => {
  ...
  return (
    <div className="mx-auto max-w-7xl p-3 sm:p-4">
      ...
      <SwitcherTabs className="mb-3" tabs={liveTabs} active={tab} onChange={setTab} />
