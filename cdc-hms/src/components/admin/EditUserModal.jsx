      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col">
        ...
        <div className="px-6 pt-4 border-b border-gray-200">
          <div className="flex items-start justify-between mb-3">
            ...
            <button onClick={onClose} className="p-2 rounded-full hover:bg-blue-50 transition">
        ...
        {activeTab === 'edit' && <div className="px-6 py-4 border-t border-gray-200 flex justify-end gap-3">
          <button
            onClick={onClose}
            className="px-4 py-2 text-sm font-semibold text-gray-600 border border-gray-300 rounded-lg hover:bg-blue-50 transition"
          >
            Cancel
          </button>
          <button
